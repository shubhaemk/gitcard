    ...
    render(){
        return(
            <div>
                ...
                <footer className='is-hidden-desktop is-hidden-tablet has-margin-bottom-10' style={{ background : (this.props.theme === 'light' ? 'hsl(0, 0%, 95%)' : 'hsl(0, 0%,5%)') , color : (this.props.theme === 'light' ? 'hsl(0, 0%, 10%)' : 'hsl(0, 0%, 90%)' )}}>
